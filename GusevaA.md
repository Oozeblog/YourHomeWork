...
После внесения изменений в репозиторий добытый путем Fork, выгрузив их в удаленный, GitHub предложить выгрузить их в первоисточник и создать Pull request - появится кнопка. При нажатии на эту кнопку изменения будут отправлены автору оригинального репозитория. Можно прикрепить текстовое сообщение к своим изменениям. Далее автор оригинального репозитория будет решать нужны ли ему наши изменения.
